import { ICalculateTimeSeries, IChartCordinates, ItimeSeries, IMapData } from './interfaces';
...
export const calculateTimeSeries = ({ years, mu, sigma, fee, initialSum, monthlySum }: ICalculateTimeSeries): IMapData[]=>
	Array.from({ length: 12 * years + 1 }, (v, idx) => idx).map((serie) => mapDate({
		years: serie / 12,
		mu,
		sigma,
		fee,
...
export const calculateTimeSeriesForTable = ({
	years,
	mu,
	sigma,
	fee,
...
export const calculateTimeSeriesForChart = ({
	years,
	mu,
	sigma,
	fee,
